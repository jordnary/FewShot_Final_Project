...
```bash
python 04_baseline_experiments/run_libfewshot_config.py 04_baseline_experiments/configs/proto_cub_5way_1shot.yaml
```

运行 5-way 5-shot：

```bash
python 04_baseline_experiments/run_libfewshot_config.py 04_baseline_experiments/configs/proto_cub_5way_5shot.yaml
```
...
该组实验使用 ResNet12 backbone，是当前阶段建议优先引用的主 baseline。
...
```text
04_baseline_experiments/results/proto_cub_resnet12_boost_5way_1shot_cloud
04_baseline_experiments/results/proto_cub_resnet12_boost_5way_5shot_cloud
```
