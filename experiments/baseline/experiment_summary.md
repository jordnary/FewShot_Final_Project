...
本实验线目标是在 CUB few-shot 分类任务上建立可复现的 ProtoNet baseline，为后续论文复现和改进方法提供对照。
...
| 实验层级 | 汇总文件 | 日志文件 |
| :--- | :--- | :--- |
| 快速 baseline | `experiments/baseline/results/summary_quick_baseline.csv` | `artifacts/logs/baseline/proto_cub_5way_1shot_console.log`; `artifacts/logs/baseline/proto_cub_5way_5shot_console.log` |
| Conv64F 正式 baseline | `experiments/baseline/results/summary_conv64f_formal_cloud.csv` | `artifacts/logs/baseline/proto_cub_conv64f_formal_5way_1shot_cloud_console.log`; `artifacts/logs/baseline/proto_cub_conv64f_formal_5way_5shot_cloud_console.log` |
| ResNet12 增强 baseline | `experiments/baseline/results/summary_resnet12_boost_cloud.csv` | `artifacts/logs/baseline/proto_cub_resnet12_boost_5way_1shot_cloud_console.log`; `artifacts/logs/baseline/proto_cub_resnet12_boost_5way_5shot_cloud_console.log` |
...
ResNet12 增强 baseline 是当前实验线最强结果。相对 Conv64F 正式 baseline，1-shot 从 36.249% 提升到 73.376%，提升 37.127 个百分点；5-shot 从 69.584% 提升到 85.945%，提升 16.361 个百分点。这说明更强 backbone 对 CUB few-shot 分类任务的贡献非常明显。
