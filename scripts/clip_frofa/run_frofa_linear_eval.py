...
This evaluates the CLIP-FroFA improvement route:
...
def parse_args():
    ...
    parser.add_argument(
        "--feature-file",
        default="artifacts/features/clip_frofa/cub_test_clip_vit_b16.npz",
    )
    parser.add_argument("--output-prefix", default="experiments/clip_frofa_improvement/results/clip_frofa_linear")
