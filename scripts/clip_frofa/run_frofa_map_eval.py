...
def parse_args():
    ...
    parser.add_argument(
        "--token-file",
        default="artifacts/features/clip_frofa/cub_test_clip_vit_b16_patch_tokens.npz",
    )
    parser.add_argument(
        "--output-prefix",
        default="experiments/clip_frofa_improvement/results/clip_vit_b16_patch_frofa_map_cub",
    )
