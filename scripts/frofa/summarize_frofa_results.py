...
LOG_DIR = PROJECT_ROOT / "artifacts" / "logs" / "frofa"
BASELINE_LOG_DIR = PROJECT_ROOT / "artifacts" / "logs" / "baseline"
RESULT_DIR = PROJECT_ROOT / "experiments" / "frofa_reproduction" / "results"
